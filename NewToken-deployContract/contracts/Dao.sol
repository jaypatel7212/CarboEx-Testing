...
contract Dao is Ownable {
    ...
    function withdrawStake() public  {
        require(isMember[msg.sender],"You are not a member of DAO"); 
        uint stakeAmount = memberWithdrawableAmount[msg.sender];
        require(stakeAmount > 0, "No stake available");
         memberWithdrawableAmount[msg.sender] = 0; 
